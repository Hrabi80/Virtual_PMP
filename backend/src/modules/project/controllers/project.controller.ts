...
export class ProjectController {
  ...
  @ApiBadRequestResponse({
    description: 'A problem occurs when creating a project. Try again!',
  })
  @UseGuards(ManagerRoleGuard)
  async createProject(
    @Body(SETTINGS.VALIDATION_PIPE) projectData: createProjectDto,
    @Request() req,
  ) {
  ...
  @ApiBadRequestResponse({
    description: 'A problem occurs when updating the project. Try again!',
  })
  @UseGuards(ManagerRoleGuard)
  async updateProject(
  ...
  @ApiBadRequestResponse({
    description: 'A problem occurred when deleting the project. Try again!',
  })
  async deleteProject(
    @Param('id', ParseIntPipe) id: number,
    @Request() req,
